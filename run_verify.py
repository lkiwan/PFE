#!/usr/bin/env python3
"""
Run backfill and verify ATW news scraper CSV output
"""
import subprocess
import sys
import os
...
print("=" * 80)
print("STEP 2: Analyzing CSV output...")
print("=" * 80)
...
# 2. Columns
print(f"\n2. Columns list: {list(df.columns)}")
...
print(f"\n3. Rows matching noise patterns (case-insensitive): {noise_count}")
...
print(f"\n4. Rows with 'news.google.com/rss/articles/' in URL: {google_rss_count}")
...
print(f"   - Unique URLs with duplicates: {dup_canonical_urls}")
...
if len(display_cols) > 0:
    ...
    print("WARNING: Display columns not all found")
